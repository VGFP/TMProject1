...
def mfcc_to_pickle():
    ...
    file_list = glob.glob("C:/Users/cjy09c/Desktop/Nowy_folder/TMProject1-master/train/*.wav")
    only_name = []
    ...
    for wave_name in only_name:
        fs, data = wavfile.read("C:/Users/cjy09c/Desktop/Nowy_folder/TMProject1-master/train/"+wave_name)
